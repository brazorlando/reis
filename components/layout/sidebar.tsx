...
const items = [
  { titulo: "Dashboard", href: "/admin", icone: LayoutDashboard },
  { titulo: "Professores", href: "/admin/professores", icone: Users },
  { titulo: "Alunos", href: "/admin/alunos", icone: GraduationCap },
  { titulo: "Estrutura", href: "/admin/estrutura", icone: School },
  { titulo: "Cargos", href: "/admin/cargos", icone: Shield },
  { titulo: "Atribuições", href: "/admin/atribuicoes", icone: Link2 },
  { titulo: "PIN de Cadastro", href: "/admin/pin", icone: KeyRound },
  { titulo: "Notas", href: "/admin/notas", icone: ClipboardList },
  { titulo: "Faltas", href: "/admin/faltas", icone: CalendarCheck },
  { titulo: "Configurações", href: "/admin/configuracoes", icone: Settings },
];
